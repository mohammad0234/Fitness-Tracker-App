...
class WorkoutComparisonSelectionScreen extends StatefulWidget {
  ...
  @override
  State<WorkoutComparisonSelectionScreen> createState() => _WorkoutComparisonSelectionScreenState();
}

class _WorkoutComparisonSelectionScreenState extends State<WorkoutComparisonSelectionScreen> {
  ...
  int _selectionStep = 1; // 1 = selecting first workout, 2 = selecting second workout
        ...
        children: [
          ...
          if (_firstWorkout != null) ...[
            ...
            if (_firstWorkout != null && _secondWorkout == null)
              const Text(
                'Now select a second workout to compare with',
                style: TextStyle(
  ...
  Widget _buildWorkoutCard(Map<String, dynamic> workoutDetail) {
    ...
    final bool isSelectable = !isSelected || 
        (_selectionStep == 2 && isFirstWorkout);
